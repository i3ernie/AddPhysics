...
export { computeNormalsGroup, setMaterialGroup, loadGopher, addMeshSelection, 
    guiRemoveFolder, redrawGeometryAndUpdateUI, addSpecificMaterialSettings, 
    addBasicMaterialSettings, createGhostTexture, addHouseAndTree, 
    addLargeGroundPlane, addDefaultCubeAndSphere, applyMeshNormalMaterial,
    initDefaultLighting, initTrackballControls, initCamera, 
    initCanvasRenderer, initRenderer, initStats }
